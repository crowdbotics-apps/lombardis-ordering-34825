...
## Project Structure
    ...
    ├── lombardis_ordering_34825  # Django project configurations
...
1. Clone this repo and `cd lombardis_ordering_34825`
...
2. Clone this repo and `cd lombardis_ordering_34825`
